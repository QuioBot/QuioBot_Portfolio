    ...
    >
      ...
      @click="add(c)">
        ...
        <h1 class="text-uppercase poppins-font">
          ...
          <!-- <span style="background-color:#cfa144">{{ heroContent.heroDesignation }}</span> -->
...
// import EducationInfo from "../about/EducationInfo";
// import ExperienceInfo from "../about/ExperienceInfo";
export default {
  data() {
    return {
